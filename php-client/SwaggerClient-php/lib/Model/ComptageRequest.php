...
/**
 * ComptageRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ComptageRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ComptageRequest';
     ...
     * @return string[]
     */
    public function getComptageAllowableValues()
    {
        return [
            self::COMPTAGE__1,
        ];
     ...
     * @return string[]
     */
    public function getSmslongAllowableValues()
    {
        return [
            self::SMSLONG__999,
        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['comptage'] = isset($data['comptage']) ? $data['comptage'] : '1';
        ...
        $this->container['smslong'] = isset($data['smslong']) ? $data['smslong'] : '999';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['comptage'] === null) {
            $invalid_properties[] = "'comptage' can't be null";
        }
        $allowed_values = array("1");
        if (!in_array($this->container['comptage'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'comptage', must be one of #{allowed_values}.";
        }
        ...
        $allowed_values = array("999");
        if (!in_array($this->container['smslong'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'smslong', must be one of #{allowed_values}.";
        }
    ...
    {
        return $this->container['comptage'];
    }

    /**
     * Sets comptage
     * @param string $comptage
     * @return $this
     */
    public function setComptage($comptage)
    {
        $allowed_values = array('1');
        if (!in_array($comptage, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'comptage', must be one of '1'");
        }
        $this->container['comptage'] = $comptage;
    ...
    {
        $allowed_values = array('999');
        if (!in_array($smslong, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'smslong', must be one of '999'");
        }
