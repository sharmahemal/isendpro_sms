...
class HlrApi
{
     ...
     *
     * @param \Swagger\Client\Model\HLRrequest $hlrrequest  (required)
     * @return \Swagger\Client\Model\HLRReponse
     ...
     *
     * @param \Swagger\Client\Model\HLRrequest $hlrrequest  (required)
     * @return Array of \Swagger\Client\Model\HLRReponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getHlrWithHttpInfo($hlrrequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\HLRReponse',
                '/hlr'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\HLRReponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\HLRReponse', $e->getResponseHeaders());
